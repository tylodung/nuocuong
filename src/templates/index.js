...
const IndexPage = ({ data, pathContext }) => {
  ...
  return (
      ...
      <div className="home-template">
        ...
        <Header image='https://website.zala.site/data/upfile/upload/17/hoa-son-dien-trang-da-lat-huong-dan-chi-duong-den-hoa-son-dien-trang-4_1.jpg' title="Phượt Ký" tagline="Chuyến đi đời tôi.." />
