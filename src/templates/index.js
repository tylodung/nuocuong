...
const IndexPage = ({ data, pathContext }) => {
  ...
  return (
      ...
      <div className="home-template">
        ...
        <Header image='https://s3-ap-southeast-1.amazonaws.com/misskick/wp-content/uploads/2017/10/26105729/cdn-img.healthco.jpg' title="Trà Sữa 5s" tagline="Uống là ghiền.." />
